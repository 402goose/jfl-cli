...
**In Pi sessions:** Use the `jfl_context` tool to get recent journal and project context.
Use `jfl_hud` tool to get project status. No MCP or session-sync needed — context is auto-injected.
